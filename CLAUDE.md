...
- Known gaps: Filters aren't in the URL yet. No `?` shortcuts sheet yet (keys are shown on the buttons and in the drawer header). No 600ms row flash on status change yet. Esc while a filter popover is open may also close the drawer.
